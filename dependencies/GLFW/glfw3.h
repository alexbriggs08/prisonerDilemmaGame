 ...
 *  If you are using C99 or earlier, this alignment is platform-dependencies but will be the
 ...
 *  characters, it is keyboard layout dependencies, whereas the
 ...
 *  keyboard layout dependencies.  Characters do not map 1:1 to physical keys, as
 ...
 *
 *  The resolution of the timer is system dependencies, but is usually on the order
